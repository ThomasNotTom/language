...
|  Keyword  | Full Name                  | Size (bytes)  |                Min                |               Max                |
| :-------: | -------------------------- | :-----------: | :-------------------------------: | :------------------------------: |
|  `uint1`  | Unsigned Integer $8$-bits  | $\frac{1}{8}$ |                $0$                |               $1$                |
|  `uint8`  | Unsigned Integer $8$-bits  |      $1$      |                $0$                |              $255$               |
| `uint16`  | Unsigned Integer $16$-bits |      $2$      |                $0$                |             $65535$              |
| `uint32`  | Unsigned Integer $32$-bits |      $4$      |                $0$                |          $2 ^ {32} - 1$          |
| `uint64`  | Unsigned Integer $64$-bits |      $8$      |                $0$                |          $2 ^ {64} - 1$          |
| `float16` | Signed Float $16$-bits     |      $2$      |             $-65504$              |             $65504$              |
| `float32` | Signed Float $32$-bits     |      $4$      |  $\approx -3.403 \times 10^{38}$  |    $\approx 3.403 × 10^{38}$     |
| `float64` | Signed Float $64$-bits     |      $8$      | $\approx  -1.798 \times 10^{308}$ | $\approx  1.798 \times 10^{308}$ |
